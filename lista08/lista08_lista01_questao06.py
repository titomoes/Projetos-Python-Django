...
while True:
    ...
    horario1 = input("Digite a hora e o minuto: Ex.: 23 10 \nDgite zero para sair: ").split()

    if horario1[0] != "0":
        hora = int(horario1[0])
        minuto = int(horario1[1])
        horario = funcoes.converte_horas(hora, minuto)
        print(funcoes.saida(horario))
